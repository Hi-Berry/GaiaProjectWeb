...
BASELINE_OFF='{"gaiaBoosterUsable":false,"lantidsEarlyPI":false,"pendingStepsPreferFull":false,"itarsBurnCandidate":false,"noFedTierUp":false,"noBuildAdjFed":false,"firaksLabLock":false,"rebellionMineSelect":false,"researchValueModel":false,"navBeforeJumpSoon":false,"fedSpendBowl3":false}'
