  ...
  return (
    <Card className="h-full overflow-y-auto border-0 rounded-none bg-[#0a0a0b] text-zinc-100 custom-scrollbar shadow-inner">
      <CardHeader className="pb-4 pt-6 px-4 space-y-4">
        <div className="flex items-center justify-between">
          <div className="space-y-1">
            <CardTitle className="text-lg font-black tracking-tighter text-white">
              {currentPlayer.name}
            </CardTitle>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full animate-pulse shadow-[0_0_8px_rgba(34,197,94,0.5)]" style={{ backgroundColor: faction?.color }} />
              <span className="text-[10px] uppercase font-bold tracking-widest text-zinc-500">{faction?.name || 'Selecting Faction...'}</span>
            </div>
          </div>
