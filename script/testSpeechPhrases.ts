...
const CASES: Array<[string, string, string?]> = [
	...
	['Eclipse: Research', ''],
	// 인공물 11종 — 어떤 인공물인지
	['Artifact: Federation benefit', 'Choose one federation reward'],
	['Artifact: Spaceship Fed', 'Tech Tile'],
	['Artifact: Gaia×3 VP', '4×3 = 12 VP'],
	['Artifact: Science×3 VP', '5×3 = 15 VP'],
	['Artifact: Tracks≥3×3 VP', '3×3 = 9 VP'],
	['Artifact: 3+Planet types VP', '3+6 = 9 VP'],
	['Artifact: Bridge sections×3 VP', '2×3 = 6 VP'],
	['Artifact: 7 VP + virtual mine (asteroid)', ''],
	['Artifact: 7 VP + virtual mine (proto)', ''],
	['Artifact: 3K 1Q', ''],
	['Artifact: 3O 3C', ''],
	['Artifact: 2O 5C', ''],
	['Artifact', 'Income: 2 to bowl 3'],
